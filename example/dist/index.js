...
var update = __webpack_require__(10)("7a0d6701", content, true, {});
...
// module
exports.push([module.i, "body{font-family:Avenir,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-align:center;color:#fff;background:#323232}.content{margin:60px auto 0;width:1000px}.head{margin-bottom:50px}.column{float:left;width:50%}table input{font:inherit;margin-bottom:10px;margin:0;outline:none;padding:8px;border:1px solid #ccc;border-radius:5px;float:left}table{display:block;width:100%;overflow:auto;word-break:normal;word-break:keep-all;-webkit-overflow-scrolling:touch}table th{font-weight:700}table td,table th{padding:.5rem 1rem}h1,h2{font-weight:400}ul{list-style-type:none;padding:0}li{display:inline-block;margin:0 10px}a{color:#42b983}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dist__ = __webpack_require__(14);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'app',
  components: {
    dragVerify: __WEBPACK_IMPORTED_MODULE_0__dist___default.a
  },
  data() {
    return {
...
"use strict";
var _typeof4=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};/******/(function(modules){// webpackBootstrap
/******/// The module cache
...
/******/__webpack_require__.p="example/dist/";/******//******/// Load entry module and return exports
/******/return __webpack_require__(__webpack_require__.s=1);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){"use strict";var _typeof=typeof Symbol==="function"&&_typeof4(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof4(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof4(obj);};var g;// This works in non-strict mode
...
// We return undefined, instead of nothing here, so it's
// easier to handle this case. if(!global) { ...}
module.exports=g;/***/},/* 1 *//***/function(module,exports,__webpack_require__){"use strict";var _vue=__webpack_require__(2);var _vue2=_interopRequireDefault(_vue);var _demo=__webpack_require__(6);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}new _vue2.default({el:'#demo',render:function render(h){return h(_demo2.default);}});/***/},/* 2 *//***/function(module,exports,__webpack_require__){"use strict";/* WEBPACK VAR INJECTION */(function(global,setImmediate){Object.defineProperty(exports,"__esModule",{value:true});var _typeof=typeof Symbol==="function"&&_typeof4(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof4(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof4(obj);};/*!
 * Vue.js v2.6.14
 * (c) 2014-2021 Evan You
 * Released under the MIT License.
...
if(!valid&&t==='object'){valid=value instanceof type;}}else if(expectedType==='Object'){valid=isPlainObject(value);}else if(expectedType==='Array'){valid=Array.isArray(value);}else{try{valid=value instanceof type;}catch(e){warn('Invalid prop type: "'+String(type)+'" is not a constructor',vm);valid=false;}}return{valid:valid,expectedType:expectedType};}var functionTypeCheckRE=/^\s*function (\w+)/;/**
 * Use function string name to check built-in types,
 * because a simple equality check will fail when running
 * across different vms / iframes.
 */function getType(fn){var match=fn&&fn.toString().match(functionTypeCheckRE);return match?match[1]:'';}function isSameType(a,b){return getType(a)===getType(b);}function getTypeIndex(type,expectedTypes){if(!Array.isArray(expectedTypes)){return isSameType(expectedTypes,type)?0:-1;}for(var i=0,len=expectedTypes.length;i<len;i++){if(isSameType(expectedTypes[i],type)){return i;}}return-1;}function getInvalidTypeMessage(name,value,expectedTypes){var message="Invalid prop: type check failed for prop \""+name+"\"."+" Expected "+expectedTypes.map(capitalize).join(', ');var expectedType=expectedTypes[0];var receivedType=toRawType(value);// check if we need to specify expected value
if(expectedTypes.length===1&&isExplicable(expectedType)&&isExplicable(typeof value==='undefined'?'undefined':_typeof(value))&&!isBoolean(expectedType,receivedType)){message+=" with value "+styleValue(value,expectedType);}message+=", got "+receivedType+" ";// check if we need to specify received value
if(isExplicable(receivedType)){message+="with value "+styleValue(value,receivedType)+".";}return message;}function styleValue(value,type){if(type==='String'){return"\""+value+"\"";}else if(type==='Number'){return""+Number(value);}else{return""+value;}}var EXPLICABLE_TYPES=['string','number','boolean'];function isExplicable(value){return EXPLICABLE_TYPES.some(function(elem){return value.toLowerCase()===elem;});}function isBoolean(){var args=[],len=arguments.length;while(len--){args[len]=arguments[len];}return args.some(function(elem){return elem.toLowerCase()==='boolean';});}/*  */function handleError(err,vm,info){// Deactivate deps tracking while processing error handler to avoid possible infinite rendering.
// See: https://github.com/vuejs/vuex/issues/1505
...
:normalizeChildren(res);var vnode=res&&res[0];return res&&(!vnode||res.length===1&&vnode.isComment&&!isAsyncPlaceholder(vnode)// #9658, #10391
 ...
 * Runtime helper for rendering <slot>
 */function renderSlot(name,fallbackRender,props,bindObject){var scopedSlotFn=this.$scopedSlots[name];var nodes;if(scopedSlotFn){// scoped slot
props=props||{};if(bindObject){if(false){warn('slot v-bind without argument expects an Object',this);}props=extend(extend({},bindObject),props);}nodes=scopedSlotFn(props)||(typeof fallbackRender==='function'?fallbackRender():fallbackRender);}else{nodes=this.$slots[name]||(typeof fallbackRender==='function'?fallbackRender():fallbackRender);}var target=props&&props.slot;if(target){return this.$createElement('template',{slot:target},nodes);}else{return nodes;}}/*  *//**
 * Runtime helper for resolving filters
 ...
 * exposed as Vue.prototype._k
 * passing in eventKeyName as last argument separately for backwards compat
 */function checkKeyCodes(eventKeyCode,key,builtInKeyCode,eventKeyName,builtInKeyName){var mappedKeyCode=config.keyCodes[key]||builtInKeyCode;if(builtInKeyName&&eventKeyName&&!config.keyCodes[key]){return isKeyNotMatch(builtInKeyName,eventKeyName);}else if(mappedKeyCode){return isKeyNotMatch(mappedKeyCode,eventKeyCode);}else if(eventKeyName){return hyphenate(eventKeyName)!==key;}return eventKeyCode===undefined;}/*  *//**
 * Runtime helper for merging v-bind="object" into a VNode's data.
...
var name=Ctor.options.name||tag;var vnode=new VNode("vue-component-"+Ctor.cid+(name?"-"+name:''),data,undefined,undefined,undefined,context,{Ctor:Ctor,propsData:propsData,listeners:listeners,tag:tag,children:children},asyncFactory);return vnode;}function createComponentInstanceForVnode(// we know it's MountedComponentVNode but flow doesn't
vnode,// activeInstance in lifecycle state
parent){var options={_isComponent:true,_parentVnode:vnode,parent:parent};// check inline-template render functions
...
if(false){warn("The .native modifier for v-on is only valid on components but it was used on <"+tag+">.",context);}vnode=new VNode(config.parsePlatformTagName(tag),data,children,undefined,undefined,context);}else if((!data||!data.pre)&&isDef(Ctor=resolveAsset(context.$options,'components',tag))){// component
...
var vnode;try{// There's no need to maintain a stack because all render fns are called
// separately from one another. Nested component's render fns are called
// when parent component is patched.
...
var oldValue=this.value;this.value=value;if(this.user){var info="callback for watcher \""+this.expression+"\"";invokeWithErrorHandling(this.cb,this.vm,[value,oldValue],this.vm,info);}else{this.cb.call(this.vm,value,oldValue);}}}};/**
 * Evaluate the value of the watcher.
 * This only gets called for lazy watchers.
...
this.vnodeToCache=vnode;this.keyToCache=key;}vnode.data.keepAlive=true;}return vnode||slot&&slot[0];}};var builtInComponents={KeepAlive:KeepAlive};/*  */function initGlobalAPI(Vue){// config
...
Object.defineProperty(Vue,'FunctionalRenderContext',{value:FunctionalRenderContext});Vue.version='2.6.14';/*  */// these are reserved for web because they are directly compiled away
// during template compilation
...
createElm(newStartVnode,insertedVnodeQueue,parentElm,oldStartVnode.elm,false,newCh,newStartIdx);}}newStartVnode=newCh[++newStartIdx];}}if(oldStartIdx>oldEndIdx){refElm=isUndef(newCh[newEndIdx+1])?null:newCh[newEndIdx+1].elm;addVnodes(parentElm,refElm,newCh,newStartIdx,newEndIdx,insertedVnodeQueue);}else if(newStartIdx>newEndIdx){removeVnodes(oldCh,oldStartIdx,oldEndIdx);}}function checkDuplicateKeys(children){var seenKeys={};for(var i=0;i<children.length;i++){var vnode=children[i];var key=vnode.key;if(isDef(key)){if(seenKeys[key]){warn("Duplicate keys detected: '"+key+"'. This may cause an update error.",vnode.context);}else{seenKeys[key]=true;}}}}function findIdxInOld(node,oldCh,start,end){for(var i=start;i<end;i++){var c=oldCh[i];if(isDef(c)&&sameVnode(node,c)){return i;}}}function patchVnode(oldVnode,vnode,insertedVnodeQueue,ownerArray,index,removeOnly){if(oldVnode===vnode){return;}if(isDef(vnode.elm)&&isDef(ownerArray)){// clone reused vnode
...
if(isDef(parentElm)){removeVnodes([oldVnode],0,0);}else if(isDef(oldVnode.tag)){invokeDestroyHook(oldVnode);}}}invokeInsertHook(vnode,insertedVnodeQueue,isInitialPatch);return vnode.elm;};}/*  */var directives={create:updateDirectives,update:updateDirectives,destroy:function unbindDirectives(vnode){updateDirectives(vnode,emptyNode);}};function updateDirectives(oldVnode,vnode){if(oldVnode.data.directives||vnode.data.directives){_update(oldVnode,vnode);}}function _update(oldVnode,vnode){var isCreate=oldVnode===emptyNode;var isDestroy=vnode===emptyNode;var oldDirs=normalizeDirectives$1(oldVnode.data.directives,oldVnode.context);var newDirs=normalizeDirectives$1(vnode.data.directives,vnode.context);var dirsWithInsert=[];var dirsWithPostpatch=[];var key,oldDir,dir;for(key in newDirs){oldDir=oldDirs[key];dir=newDirs[key];if(!oldDir){// new directive, bind
...
if(isDef(attrs.__ob__)){attrs=vnode.data.attrs=extend({},attrs);}for(key in attrs){cur=attrs[key];old=oldAttrs[key];if(old!==cur){setAttr(elm,key,cur,vnode.data.pre);}}// #4391: in IE9, setting type can reset value for input[type=radio]
// #6666: IE/Edge forces progress value down to 1 before setting a max
/* istanbul ignore if */if((isIE||isEdge)&&attrs.value!==oldAttrs.value){setAttr(elm,'value',attrs.value);}for(key in oldAttrs){if(isUndef(attrs[key])){if(isXlink(key)){elm.removeAttributeNS(xlinkNS,getXlinkProp(key));}else if(!isEnumeratedAttr(key)){elm.removeAttribute(key);}}}}function setAttr(el,key,value,isInPre){if(isInPre||el.tagName.indexOf('-')>-1){baseSetAttr(el,key,value);}else if(isBooleanAttr(key)){// set attribute for blank value
// e.g. <option disabled>Select one</option>
...
process.versions={};function noop(){}process.on=noop;process.addListener=noop;process.once=noop;process.off=noop;process.removeListener=noop;process.removeAllListeners=noop;process.emit=noop;process.prependListener=noop;process.prependOnceListener=noop;process.listeners=function(name){return[];};process.binding=function(name){throw new Error('process.binding is not supported');};process.cwd=function(){return'/';};process.chdir=function(dir){throw new Error('process.chdir is not supported');};process.umask=function(){return 0;};/***/},/* 6 *//***/function(module,exports,__webpack_require__){function injectStyle(ssrContext){__webpack_require__(7);}var Component=__webpack_require__(12)(/* script */__webpack_require__(13),/* template */__webpack_require__(15),/* styles */injectStyle,/* scopeId */null,/* moduleIdentifier (server only) */null);module.exports=Component.exports;/***/},/* 7 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
var content=__webpack_require__(8);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(10)("7a0d6701",content,true,{});/***/},/* 8 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(9)();// imports
// module
exports.push([module.i,"body{font-family:Avenir,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-align:center;color:#fff;background:#323232}.content{margin:60px auto 0;width:1000px}.head{margin-bottom:50px}.column{float:left;width:50%}table input{font:inherit;margin-bottom:10px;margin:0;outline:none;padding:8px;border:1px solid #ccc;border-radius:5px;float:left}table{display:block;width:100%;overflow:auto;word-break:normal;word-break:keep-all;-webkit-overflow-scrolling:touch}table th{font-weight:700}table td,table th{padding:.5rem 1rem}h1,h2{font-weight:400}ul{list-style-type:none;padding:0}li{display:inline-block;margin:0 10px}a{color:#42b983}",""]);// exports
...
//  when a module is imported multiple times with different media queries.
//  I hope this will never occur (Hey this way we have smaller bundles)
if(typeof item[0]!=="number"||!alreadyImportedModules[item[0]]){if(mediaQuery&&!item[2]){item[2]=mediaQuery;}else if(mediaQuery){item[2]="("+item[2]+") and ("+mediaQuery+")";}list.push(item);}}};return list;};/***/},/* 10 *//***/function(module,exports,__webpack_require__){/*
  MIT License http://www.opensource.org/licenses/mit-license.php
  Author Tobias Koppers @sokra
  Modified by Evan You @yyx990803
*/var hasDocument=typeof document!=='undefined';if(typeof DEBUG!=='undefined'&&DEBUG){if(!hasDocument){throw new Error('vue-style-loader cannot be used in a non-browser environment. '+"Use { target: 'node' } in your Webpack config to indicate a server-rendering environment.");}}var listToStyles=__webpack_require__(11);/*
type StyleObject = {
  id: number;
  parts: Array<StyleObjectPart>
}
...
css+='\n/*# sourceMappingURL=data:application/json;base64,'+btoa(unescape(encodeURIComponent(JSON.stringify(sourceMap))))+' */';}if(styleElement.styleSheet){styleElement.styleSheet.cssText=css;}else{while(styleElement.firstChild){styleElement.removeChild(styleElement.firstChild);}styleElement.appendChild(document.createTextNode(css));}}/***/},/* 11 *//***/function(module,exports,__webpack_require__){"use strict";/**
 * Translates the list format produced by css-loader into something
 * easier to manipulate.
 */module.exports=function listToStyles(parentId,list){var styles=[];var newStyles={};for(var i=0;i<list.length;i++){var item=list[i];var id=item[0];var css=item[1];var media=item[2];var sourceMap=item[3];var part={id:parentId+':'+i,css:css,media:media,sourceMap:sourceMap};if(!newStyles[id]){styles.push(newStyles[id]={id:id,parts:[part]});}else{newStyles[id].parts.push(part);}}return styles;};/***/},/* 12 *//***/function(module,exports){/* globals __VUE_SSR_CONTEXT__ */// this module is a runtime utility for cleaner component module output and will
// be included in the final webpack user bundle
...
options.render=function renderWithStyleInjection(h,context){hook.call(context);return existing(h,context);};}}return{esModule:esModule,exports:scriptExports,options:options};};/***/},/* 13 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__dist__=__webpack_require__(14);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__dist___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__dist__);//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'app',components:{dragVerify:__WEBPACK_IMPORTED_MODULE_0__dist___default.a},data:function data(){return{handlerIcon:'fa fa-angle-double-right',successIcon:'fa fa-check',background:'#cccccc',progressBarBg:'#FFFF99',completedBg:'#66cc66',handlerBg:'#fff',text:'swiping to the right side',successText:'success',width:400,height:60,textSize:'20px',isCircle:'true'};},computed:{getShape:function getShape(){return this.isCircle==='true';}},methods:{success:function success(){// console.log('pass')
}}};/***/},/* 14 *//***/function(module,exports,__webpack_require__){"use strict";var _typeof3=typeof Symbol==="function"&&_typeof4(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof4(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof4(obj);};/******/(function(modules){// webpackBootstrap
/******/// The module cache
/******/var installedModules={};/******//******/// The require function
/******/function __webpack_require__(moduleId){/******//******/// Check if module is in cache
/******/if(installedModules[moduleId]){/******/return installedModules[moduleId].exports;/******/}/******/// Create a new module (and put it into the cache)
...
/******/__webpack_require__.o=function(object,property){return Object.prototype.hasOwnProperty.call(object,property);};/******//******/// __webpack_public_path__
/******/__webpack_require__.p="example/dist/";/******//******/// Load entry module and return exports
/******/return __webpack_require__(__webpack_require__.s=1);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){"use strict";var _typeof=typeof Symbol==="function"&&_typeof3(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof3(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof3(obj);};var g;// This works in non-strict mode
g=function(){return this;}();try{// This works if eval is allowed (see CSP)
g=g||Function("return this")()||(1,eval)("this");}catch(e){// This works if the window reference is available
if((typeof window==="undefined"?"undefined":_typeof(window))==="object")g=window;}// g can still be undefined, but nothing to do about it...
// We return undefined, instead of nothing here, so it's
// easier to handle this case. if(!global) { ...}
module.exports=g;/***/},/* 1 *//***/function(module,exports,__webpack_require__){"use strict";var _vue=__webpack_require__(2);var _vue2=_interopRequireDefault(_vue);var _demo=__webpack_require__(6);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}new _vue2.default({el:'#demo',render:function render(h){return h(_demo2.default);}});/***/},/* 2 *//***/function(module,exports,__webpack_require__){"use strict";/* WEBPACK VAR INJECTION */(function(global,setImmediate){Object.defineProperty(exports,"__esModule",{value:true});var _typeof=typeof Symbol==="function"&&_typeof3(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof3(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof3(obj);};/*!
 * Vue.js v2.6.14
 * (c) 2014-2021 Evan You
 * Released under the MIT License.
 *//*  */var emptyObject=Object.freeze({});// These helpers produce better VM code in JS engines due to their
...
//
/* harmony default export */__webpack_exports__["default"]={name:'app',components:{dragVerify:__WEBPACK_IMPORTED_MODULE_0__dist___default.a},data:function data(){return{handlerIcon:'fa fa-angle-double-right',successIcon:'fa fa-check',background:'#cccccc',progressBarBg:'#FFFF99',completedBg:'#66cc66',handlerBg:'#fff',text:'swiping to the right side',successText:'success',width:400,height:60,textSize:'20px',isCircle:'true'};},computed:{getShape:function getShape(){return this.isCircle==='true';}},methods:{success:function success(){// console.log('pass')
}}};/***/},/* 14 *//***/function(module,exports,__webpack_require__){"use strict";var _typeof2=typeof Symbol==="function"&&_typeof3(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof3(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof3(obj);};/******/(function(modules){// webpackBootstrap
/******/// The module cache
/******/var installedModules={};/******//******/// The require function
/******/function __webpack_require__(moduleId){/******//******/// Check if module is in cache
/******/if(installedModules[moduleId]){/******/return installedModules[moduleId].exports;/******/}/******/// Create a new module (and put it into the cache)
...
/******/__webpack_require__.o=function(object,property){return Object.prototype.hasOwnProperty.call(object,property);};/******//******/// __webpack_public_path__
/******/__webpack_require__.p="example/dist/";/******//******/// Load entry module and return exports
/******/return __webpack_require__(__webpack_require__.s=1);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){"use strict";var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};var g;// This works in non-strict mode
g=function(){return this;}();try{// This works if eval is allowed (see CSP)
g=g||Function("return this")()||(1,eval)("this");}catch(e){// This works if the window reference is available
if((typeof window==="undefined"?"undefined":_typeof(window))==="object")g=window;}// g can still be undefined, but nothing to do about it...
// We return undefined, instead of nothing here, so it's
// easier to handle this case. if(!global) { ...}
module.exports=g;/***/},/* 1 *//***/function(module,exports,__webpack_require__){"use strict";var _vue=__webpack_require__(2);var _vue2=_interopRequireDefault(_vue);var _demo=__webpack_require__(6);var _demo2=_interopRequireDefault(_demo);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}new _vue2.default({el:'#demo',render:function render(h){return h(_demo2.default);}});/***/},/* 2 *//***/function(module,exports,__webpack_require__){"use strict";/* WEBPACK VAR INJECTION */(function(global,setImmediate){Object.defineProperty(exports,"__esModule",{value:true});var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};/*!
     * Vue.js v2.6.14
     * (c) 2014-2021 Evan You
     * Released under the MIT License.
     *//*  */var emptyObject=Object.freeze({});// These helpers produce better VM code in JS engines due to their
...
// load the styles
var content=__webpack_require__(8);if(typeof content==='string')content=[[module.i,content,'']];if(content.locals)module.exports=content.locals;// add the styles to the DOM
var update=__webpack_require__(10)("356d9864",content,true,{});/***/},/* 8 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(9)();// imports
// module
exports.push([module.i,"body{font-family:Avenir,Helvetica,Arial,sans-serif;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale;text-align:center;color:#fff;background:#323232}.content{margin:60px auto 0;width:1000px}.head{margin-bottom:50px}.column{float:left;width:50%}table input{font:inherit;margin-bottom:10px;margin:0;outline:none;padding:8px;border:1px solid #ccc;border-radius:5px;float:left}table{display:block;width:100%;overflow:auto;word-break:normal;word-break:keep-all;-webkit-overflow-scrolling:touch}table th{font-weight:700}table td,table th{padding:.5rem 1rem}h1,h2{font-weight:400}ul{list-style-type:none;padding:0}li{display:inline-block;margin:0 10px}a{color:#42b983}",""]);// exports
/***/},/* 9 *//***/function(module,exports,__webpack_require__){"use strict";/*
  	MIT License http://www.opensource.org/licenses/mit-license.php
...
//
/* harmony default export */__webpack_exports__["default"]={name:'app',components:{dragVerify:__WEBPACK_IMPORTED_MODULE_0__dist___default.a},data:function data(){return{handlerIcon:'fa fa-angle-double-right',successIcon:'fa fa-check',background:'#cccccc',progressBarBg:'#FFFF99',completedBg:'#66cc66',handlerBg:'#fff',text:'swiping to the right side',successText:'success',width:400,height:60,textSize:'20px',isCircle:'true'};},computed:{getShape:function getShape(){return this.isCircle==='true';}},methods:{success:function success(){// console.log('pass')
}}};/***/},/* 14 *//***/function(module,exports,__webpack_require__){"use strict";var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};module.exports=/******/function(modules){// webpackBootstrap
/******/// The module cache
/******/var installedModules={};/******//******/// The require function
/******/function __webpack_require__(moduleId){/******//******/// Check if module is in cache
/******/if(installedModules[moduleId]){/******/return installedModules[moduleId].exports;/******/}/******/// Create a new module (and put it into the cache)
...
/******/return __webpack_require__(__webpack_require__.s=0);/******/}(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _DragVerify=__webpack_require__(1);var _DragVerify2=_interopRequireDefault(_DragVerify);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default=_DragVerify2.default;/***/},/* 1 *//***/function(module,exports,__webpack_require__){function injectStyle(ssrContext){__webpack_require__(2);}var Component=__webpack_require__(7)(/* script */__webpack_require__(8),/* template */__webpack_require__(9),/* styles */injectStyle,/* scopeId */null,/* moduleIdentifier (server only) */null);module.exports=Component.exports;/***/},/* 2 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
// load the styles
...
var update=__webpack_require__(5)("74306a7d",content,true,{});/***/},/* 3 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(4)();// imports
// module
exports.push([module.i,".drag_verify{position:relative;background-color:#e8e8e8;text-align:center}.drag_verify .dv_handler{position:absolute;top:0;left:0;border:1px solid #ccc;cursor:move}.drag_verify .dv_handler i{color:#666;font-size:1.5em}.drag_verify .dv_progress_bar{position:absolute;height:34px;width:0;transition:background 2s ease-in}.drag_verify .dv_text{position:absolute;top:0;color:#444;-moz-user-select:none;-webkit-user-select:none;user-select:none;-o-user-select:none;-ms-user-select:none}",""]);// exports
...
// this makes source maps inside style tags work properly in Chrome
css+='\n/*# sourceURL='+sourceMap.sources[0]+' */';// http://stackoverflow.com/a/26603875
css+='\n/*# sourceMappingURL=data:application/json;base64,'+btoa(unescape(encodeURIComponent(JSON.stringify(sourceMap))))+' */';}if(styleElement.styleSheet){styleElement.styleSheet.cssText=css;}else{while(styleElement.firstChild){styleElement.removeChild(styleElement.firstChild);}styleElement.appendChild(document.createTextNode(css));}}/***/},/* 6 *//***/function(module,exports,__webpack_require__){"use strict";/**
     * Translates the list format produced by css-loader into something
     * easier to manipulate.
     */module.exports=function listToStyles(parentId,list){var styles=[];var newStyles={};for(var i=0;i<list.length;i++){var item=list[i];var id=item[0];var css=item[1];var media=item[2];var sourceMap=item[3];var part={id:parentId+':'+i,css:css,media:media,sourceMap:sourceMap};if(!newStyles[id]){styles.push(newStyles[id]={id:id,parts:[part]});}else{newStyles[id].parts.push(part);}}return styles;};/***/},/* 7 *//***/function(module,exports){/* globals __VUE_SSR_CONTEXT__ */// this module is a runtime utility for cleaner component module output and will
// be included in the final webpack user bundle
module.exports=function normalizeComponent(rawScriptExports,compiledTemplate,injectStyles,scopeId,moduleIdentifier/* server only */){var esModule;var scriptExports=rawScriptExports=rawScriptExports||{};// ES6 modules interop
...
options._ssrRegister=hook;}else if(injectStyles){hook=injectStyles;}if(hook){var functional=options.functional;var existing=functional?options.render:options.beforeCreate;if(!functional){// inject component registration as beforeCreate hook
options.beforeCreate=existing?[].concat(existing,hook):[hook];}else{// register for functioal component in vue file
options.render=function renderWithStyleInjection(h,context){hook.call(context);return existing(h,context);};}}return{esModule:esModule,exports:scriptExports,options:options};};/***/},/* 8 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});//
//
//
//
//
...
//
//
/* harmony default export */__webpack_exports__["default"]={name:'DragVerify',props:{width:{type:Number,default:200},height:{type:Number,default:60},text:{type:String,default:'swiping to the right side'},successText:{type:String,default:'success'},background:{type:String,default:'#ccc'},progressBarBg:{type:String,default:'#FFFF99'},completedBg:{type:String,default:'#66cc66'},circle:{type:Boolean,default:true},handlerIcon:{type:String},successIcon:{type:String},handlerBg:{type:String,default:'#fff'},textSize:{type:String,default:'20px'}},computed:{handlerStyle:function handlerStyle(){return{left:'0px',width:this.height-2+'px',height:this.height-2+'px',borderRadius:this.circle?'50%':0,background:this.handlerBg};},message:function message(){return this.isPassing?this.successText:this.text;},dragVerifyStyle:function dragVerifyStyle(){return{width:this.width+'px',height:this.height+'px',lineHeight:this.height+'px',background:this.background,borderRadius:this.circle?this.height/2+'px':0};},progressBarStyle:function progressBarStyle(){return{background:this.progressBarBg,height:this.height+'px',borderRadius:this.circle?this.height/2+'px':0};},textStyle:function textStyle(){return{height:this.height+'px',width:this.width+'px',fontSize:this.textSize};},handlerIconClass:function handlerIconClass(){return this.isPassing?this.handlerIcon:this.successIcon;}},data:function data(){return{isMoving:false,x:0,isPassing:false};},mounted:function mounted(){this.init();},methods:{init:function init(){},dragStart:function dragStart(e){if(!this.isPassing){this.isMoving=true;var handler=this.$refs.handler;this.x=(e.pageX||e.touches[0].pageX)-parseInt(handler.style.left.replace('px',''),10);}},dragMoving:function dragMoving(e){if(this.isMoving&&!this.isPassing){var _x=(e.pageX||e.touches[0].pageX)-this.x;var handler=this.$refs.handler;if(_x>0&&_x<=this.width-this.height){handler.style.left=_x+'px';this.$refs.progressBar.style.width=_x+this.height+'px';}else if(_x>this.width-this.height){handler.style.left=this.width+'px';this.$refs.progressBar.style.width=this.width+'px';this.passVerify();}}},dragFinish:function dragFinish(e){if(this.isMoving&&!this.isPassing){var _x=(e.pageX||e.changedTouches[0].pageX)-this.x;if(_x<this.width-this.height){this.$refs.handler.style.left='0';this.$refs.progressBar.style.width='0';}this.isMoving=false;}},passVerify:function passVerify(){this.isPassing=true;this.isMoving=false;var handler=this.$refs.handler;handler.className+=' dv_handler_ok_bg';handler.children[0].className=this.successIcon;this.$refs.progressBar.style.background=this.completedBg;this.$refs.message.style.color='#fff';this.$emit('success-callback');}}};/***/},/* 9 *//***/function(module,exports){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"drag_verify",style:_vm.dragVerifyStyle,on:{"mousemove":_vm.dragMoving,"mouseup":_vm.dragFinish,"touchmove":_vm.dragMoving,"touchend":_vm.dragFinish}},[_c('div',{ref:"progressBar",staticClass:"dv_progress_bar",style:_vm.progressBarStyle}),_vm._v(" "),_c('div',{ref:"message",staticClass:"dv_text",style:_vm.textStyle},[_vm._v(_vm._s(_vm.message))]),_vm._v(" "),!_vm.isPassing?_c('div',{ref:"handler",staticClass:"dv_handler dv_handler_bg",style:_vm.handlerStyle,on:{"mousedown":_vm.dragStart,"touchstart":_vm.dragStart}},[_c('i',{class:_vm.handlerIcon})]):_vm._e()]);},staticRenderFns:[]/***/};}]/******/);/***/},/* 15 *//***/function(module,exports){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('div',{staticClass:"content"},[_vm._m(0),_vm._v(" "),_c('section',{staticClass:"demo-section"},[_c('div',{staticClass:"column"},[_c('drag-verify',{attrs:{"width":_vm.width,"height":_vm.height,"text":_vm.text,"success-text":_vm.successText,"background":_vm.background,"progress-bar-bg":_vm.progressBarBg,"completed-bg":_vm.completedBg,"handler-bg":_vm.handlerBg,"handler-icon":_vm.handlerIcon,"text-size":_vm.textSize,"success-icon":_vm.successIcon,"circle":_vm.getShape},on:{"success-callback":_vm.success}})],1),_vm._v(" "),_c('div',{staticClass:"column"},[_c('table',[_c('tr',[_c('td',[_vm._v("width")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.width,expression:"width"}],attrs:{"type":"text"},domProps:{"value":_vm.width},on:{"input":function input($event){if($event.target.composing){return;}_vm.width=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("height")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.height,expression:"height"}],attrs:{"type":"text"},domProps:{"value":_vm.height},on:{"input":function input($event){if($event.target.composing){return;}_vm.height=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("text")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.text,expression:"text"}],attrs:{"type":"text"},domProps:{"value":_vm.text},on:{"input":function input($event){if($event.target.composing){return;}_vm.text=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("successText")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.successText,expression:"successText"}],attrs:{"type":"text"},domProps:{"value":_vm.successText},on:{"input":function input($event){if($event.target.composing){return;}_vm.successText=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("background")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.background,expression:"background"}],attrs:{"type":"color"},domProps:{"value":_vm.background},on:{"input":function input($event){if($event.target.composing){return;}_vm.background=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("progressBarBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.progressBarBg,expression:"progressBarBg"}],attrs:{"type":"color"},domProps:{"value":_vm.progressBarBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.progressBarBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("completedBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.completedBg,expression:"completedBg"}],attrs:{"type":"color"},domProps:{"value":_vm.completedBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.completedBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("handlerBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.handlerBg,expression:"handlerBg"}],attrs:{"type":"color"},domProps:{"value":_vm.handlerBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.handlerBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("textSize")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.textSize,expression:"textSize"}],attrs:{"type":"text"},domProps:{"value":_vm.textSize},on:{"input":function input($event){if($event.target.composing){return;}_vm.textSize=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("isCircle")]),_vm._v(" "),_c('td',[_c('select',{directives:[{name:"model",rawName:"v-model",value:_vm.isCircle,expression:"isCircle"}],on:{"change":function change($event){var $$selectedVal=Array.prototype.filter.call($event.target.options,function(o){return o.selected;}).map(function(o){var val="_value"in o?o._value:o.value;return val;});_vm.isCircle=$event.target.multiple?$$selectedVal:$$selectedVal[0];}}},[_c('option',[_vm._v("true")]),_vm._v(" "),_c('option',[_vm._v("false")])])])])])])])])]);},staticRenderFns:[function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"head"},[_c('h1',[_vm._v("Vue Verify")]),_vm._v(" "),_c('h3',[_vm._v("This is a vue component, which is sliding to unlock for login or sign up.")])]);}]/***/};}]/******/);/***/},/* 15 *//***/function(module,exports){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('div',{staticClass:"content"},[_vm._m(0),_vm._v(" "),_c('section',{staticClass:"demo-section"},[_c('div',{staticClass:"column"},[_c('drag-verify',{attrs:{"width":_vm.width,"height":_vm.height,"text":_vm.text,"success-text":_vm.successText,"background":_vm.background,"progress-bar-bg":_vm.progressBarBg,"completed-bg":_vm.completedBg,"handler-bg":_vm.handlerBg,"handler-icon":_vm.handlerIcon,"text-size":_vm.textSize,"success-icon":_vm.successIcon,"circle":_vm.getShape},on:{"success-callback":_vm.success}})],1),_vm._v(" "),_c('div',{staticClass:"column"},[_c('table',[_c('tr',[_c('td',[_vm._v("width")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.width,expression:"width"}],attrs:{"type":"text"},domProps:{"value":_vm.width},on:{"input":function input($event){if($event.target.composing){return;}_vm.width=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("height")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.height,expression:"height"}],attrs:{"type":"text"},domProps:{"value":_vm.height},on:{"input":function input($event){if($event.target.composing){return;}_vm.height=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("text")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.text,expression:"text"}],attrs:{"type":"text"},domProps:{"value":_vm.text},on:{"input":function input($event){if($event.target.composing){return;}_vm.text=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("successText")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.successText,expression:"successText"}],attrs:{"type":"text"},domProps:{"value":_vm.successText},on:{"input":function input($event){if($event.target.composing){return;}_vm.successText=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("background")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.background,expression:"background"}],attrs:{"type":"color"},domProps:{"value":_vm.background},on:{"input":function input($event){if($event.target.composing){return;}_vm.background=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("progressBarBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.progressBarBg,expression:"progressBarBg"}],attrs:{"type":"color"},domProps:{"value":_vm.progressBarBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.progressBarBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("completedBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.completedBg,expression:"completedBg"}],attrs:{"type":"color"},domProps:{"value":_vm.completedBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.completedBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("handlerBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.handlerBg,expression:"handlerBg"}],attrs:{"type":"color"},domProps:{"value":_vm.handlerBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.handlerBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("textSize")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.textSize,expression:"textSize"}],attrs:{"type":"text"},domProps:{"value":_vm.textSize},on:{"input":function input($event){if($event.target.composing){return;}_vm.textSize=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("isCircle")]),_vm._v(" "),_c('td',[_c('select',{directives:[{name:"model",rawName:"v-model",value:_vm.isCircle,expression:"isCircle"}],on:{"change":function change($event){var $$selectedVal=Array.prototype.filter.call($event.target.options,function(o){return o.selected;}).map(function(o){var val="_value"in o?o._value:o.value;return val;});_vm.isCircle=$event.target.multiple?$$selectedVal:$$selectedVal[0];}}},[_c('option',[_vm._v("true")]),_vm._v(" "),_c('option',[_vm._v("false")])])])])])])])])]);},staticRenderFns:[function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"head"},[_c('h1',[_vm._v("Vue2 Drag Verify")]),_vm._v(" "),_c('h3',[_vm._v("This is a vue component, which is sliding to unlock for login or sign up.")])]);}]/***/};}]/******/);/***/},/* 15 *//***/function(module,exports){module.exports={render:function render(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('div',{staticClass:"content"},[_vm._m(0),_vm._v(" "),_c('section',{staticClass:"demo-section"},[_c('div',{staticClass:"column"},[_c('drag-verify',{attrs:{"width":_vm.width,"height":_vm.height,"text":_vm.text,"success-text":_vm.successText,"background":_vm.background,"progress-bar-bg":_vm.progressBarBg,"completed-bg":_vm.completedBg,"handler-bg":_vm.handlerBg,"handler-icon":_vm.handlerIcon,"text-size":_vm.textSize,"success-icon":_vm.successIcon,"circle":_vm.getShape},on:{"success-callback":_vm.success}})],1),_vm._v(" "),_c('div',{staticClass:"column"},[_c('table',[_c('tr',[_c('td',[_vm._v("width")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.width,expression:"width"}],attrs:{"type":"text"},domProps:{"value":_vm.width},on:{"input":function input($event){if($event.target.composing){return;}_vm.width=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("height")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.height,expression:"height"}],attrs:{"type":"text"},domProps:{"value":_vm.height},on:{"input":function input($event){if($event.target.composing){return;}_vm.height=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("text")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.text,expression:"text"}],attrs:{"type":"text"},domProps:{"value":_vm.text},on:{"input":function input($event){if($event.target.composing){return;}_vm.text=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("successText")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.successText,expression:"successText"}],attrs:{"type":"text"},domProps:{"value":_vm.successText},on:{"input":function input($event){if($event.target.composing){return;}_vm.successText=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("background")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.background,expression:"background"}],attrs:{"type":"color"},domProps:{"value":_vm.background},on:{"input":function input($event){if($event.target.composing){return;}_vm.background=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("progressBarBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.progressBarBg,expression:"progressBarBg"}],attrs:{"type":"color"},domProps:{"value":_vm.progressBarBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.progressBarBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("completedBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.completedBg,expression:"completedBg"}],attrs:{"type":"color"},domProps:{"value":_vm.completedBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.completedBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("handlerBg")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.handlerBg,expression:"handlerBg"}],attrs:{"type":"color"},domProps:{"value":_vm.handlerBg},on:{"input":function input($event){if($event.target.composing){return;}_vm.handlerBg=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("textSize")]),_vm._v(" "),_c('td',[_c('input',{directives:[{name:"model",rawName:"v-model",value:_vm.textSize,expression:"textSize"}],attrs:{"type":"text"},domProps:{"value":_vm.textSize},on:{"input":function input($event){if($event.target.composing){return;}_vm.textSize=$event.target.value;}}})])]),_vm._v(" "),_c('tr',[_c('td',[_vm._v("isCircle")]),_vm._v(" "),_c('td',[_c('select',{directives:[{name:"model",rawName:"v-model",value:_vm.isCircle,expression:"isCircle"}],on:{"change":function change($event){var $$selectedVal=Array.prototype.filter.call($event.target.options,function(o){return o.selected;}).map(function(o){var val="_value"in o?o._value:o.value;return val;});_vm.isCircle=$event.target.multiple?$$selectedVal:$$selectedVal[0];}}},[_c('option',[_vm._v("true")]),_vm._v(" "),_c('option',[_vm._v("false")])])])])])])])])]);},staticRenderFns:[function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"head"},[_c('h1',[_vm._v("Vue2 Drag Verify")]),_vm._v(" "),_c('h3',[_vm._v("This is a vue component, which is sliding to unlock for login or sign up.")])]);}]/***/};}]/******/);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    on: {
      "success-callback": _vm.success
    }
  })], 1), _vm._v(" "), _c('div', {
    staticClass: "column"
  }, [_c('table', [_c('tr', [_c('td', [_vm._v("width")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.width),
  ...
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("height")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.height),
  ...
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("text")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.text),
  ...
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("successText")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.successText),
      expression: "successText"
    }],
    attrs: {
      "type": "text"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.successText = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("background")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("progressBarBg")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.progressBarBg),
      expression: "progressBarBg"
    }],
    attrs: {
      "type": "color"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.progressBarBg = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("completedBg")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.completedBg),
      expression: "completedBg"
    }],
    attrs: {
      "type": "color"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.completedBg = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("handlerBg")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.handlerBg),
      expression: "handlerBg"
    }],
    attrs: {
      "type": "color"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.handlerBg = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("textSize")]), _vm._v(" "), _c('td', [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.textSize),
  ...
  })])]), _vm._v(" "), _c('tr', [_c('td', [_vm._v("isCircle")]), _vm._v(" "), _c('td', [_c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.isCircle),
    ...
    on: {
      "change": function($event) {
        ...
        _vm.isCircle = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
      }
    }
  }, [_c('option', [_vm._v("true")]), _vm._v(" "), _c('option', [_vm._v("false")])])])])])])])])])
